...
export default function FilterBar({categories}: {categories: Category[]}) {
    ...
    return (
        <aside className="w-full shrink-0 md:w-56">
            <h2 className="mb-4 font-display text-lg font-semibold text-foreground">Filters</h2>
            ...
            <div className="mb-6">
                <p className="mb-2 text-sm font-medium text-foreground">Price (AED)</p>
                <div className="flex items-center gap-2">
                    <input
                        ...
                        placeholder="Min"
                        inputMode="numeric"
                        className="w-20 rounded-md border border-line bg-surface px-2 py-1 text-sm text-foreground placeholder:text-muted focus:border-brand focus:outline-none"
                    />
